...
/**
 * ElasticSearch client wrapper, use new rest client.
 *
 * @author wangnan
 * @since 1.0
 */
public class RestElasticSearchClient extends EsClient {
    ...
    public RestElasticSearchClient(RestHighLevelClient client) {
        super(client);
    ...
    public Map<String, Object> get(String index, String type, String id) {
        ...
        try {
            response = client.get(new GetRequest(index, type, id));
